...
| 代码域 | 先读文档 | 再读详细设计 |
|---|---|---|
| 壳层、活动视图、页面层级 | `01-需求与PRD/02-用户旅程与信息架构.md`, `02-产品设计/01-页面与交互PRD.md` | `06-详细设计库/01-UI详细设计/`, `06-详细设计库/04-模块开发设计/07-系统壳层与知识底座开发设计.md` |
| 文档工作台与表格工件 | `02-产品设计/01-页面与交互PRD.md`, `03-架构实现/01-系统架构与分层Owner.md` | `06-详细设计库/02-原子功能实现方案/02-工程与文件/`, `06-详细设计库/02-原子功能实现方案/03-文档编辑与知识关系/`, `06-详细设计库/03-代码契约与唯一性/06-文档工作台代码契约.md` |
| AI 会话、阶段、review | `03-架构实现/02-AI编排运行时.md` | `06-详细设计库/02-原子功能实现方案/04-AI会话与阶段控制/`, `06-详细设计库/04-模块开发设计/03-AI会话与阶段控制开发设计.md` |
| 编排、运行、审批、重跑 | `02-产品设计/02-编排工作台PRD.md`, `03-架构实现/02-AI编排运行时.md` | `06-详细设计库/02-原子功能实现方案/05-编排与流程资产/`, `06-详细设计库/02-原子功能实现方案/06-模板工件与导出/`, `06-详细设计库/03-代码契约与唯一性/08-编排层与Flow编辑器代码契约.md` |
| 资源导入与模板/技能/角色 | `02-产品设计/01-页面与交互PRD.md`, `03-架构实现/03-数据契约状态机与安全.md` | `06-详细设计库/02-原子功能实现方案/01-平台入口与模板/`, `06-详细设计库/02-原子功能实现方案/07-技能连接与模型/`, `06-详细设计库/04-模块开发设计/06-技能连接与模型中心开发设计.md` |
| 规则、知识底座、思路地图 | `01-需求与PRD/02-用户旅程与信息架构.md`, `03-架构实现/03-数据契约状态机与安全.md` | `06-详细设计库/02-原子功能实现方案/09-知识索引与上下文管理/`, `06-详细设计库/04-模块开发设计/07-系统壳层与知识底座开发设计.md`, `06-详细设计库/03-代码契约与唯一性/34-混合检索与ContextPack规则.md` |
